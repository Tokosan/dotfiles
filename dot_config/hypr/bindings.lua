...
hl.bind(mainMod .. " + CONTROL + V", hl.dsp.exec_cmd("wallpaper-video toggle --monitor focused"), { desc = "Toggle animated wallpaper" })
hl.bind(mainMod .. " + CONTROL + SHIFT + V", hl.dsp.exec_cmd("wallpaper-video next --monitor focused"), { desc = "Next animated wallpaper" })
hl.bind(mainMod .. " + CONTROL + B", hl.dsp.exec_cmd("wallpaper-scene toggle --monitor focused"), { desc = "Toggle Wallpaper Engine scene" })
hl.bind(mainMod .. " + CONTROL + SHIFT + B", hl.dsp.exec_cmd("wallpaper-scene next --monitor focused"), { desc = "Next Wallpaper Engine scene" })
